const translations = {
  ...
  "manifesto.insight": {
    ...
    fr: "Nous vous redonnons le pouvoir et vous libérons des frais excessifs appliqués par des intermédiaires désormais obsolètes. Résultat : vous financez l'économie, l'économie vous paye des intérêts. C'est tout.",
  },
  "manifesto.commodity": {
