...
// Full French content WITH the sidebar inserted at the right location
...
// English content WITH the sidebar
...
async function updateArticle() {
    console.log('🔄 Adding sidebar to Analyse Concurrentielle article...\n');
    ...
    try {
        ...
        console.log('   - Positioned after robo-advisor description');
